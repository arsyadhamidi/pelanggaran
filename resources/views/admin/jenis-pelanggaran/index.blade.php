        ...
        <div class="col-lg">
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('data-jenispelanggaran.create') }}" class="btn btn-primary">
                        ...
                        <tbody>
                            @foreach ($jenis as $data)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('data-jenispelanggaran.destroy', $data->id) }}"
                                            method="POST" class="d-flex flex-wrap">
                                            @csrf
                                            <a href="{{ route('data-jenispelanggaran.edit', $data->id) }}"
