    ...
    <div class="header_section">
        <div class="container-fluid">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <div class="logo"><a href="/" class="h1 font-weight-bold text-white">YETERA</a></div>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <form class="form-inline my-2 my-lg-0">
                        <div class="quote_btn"><a href="/login"><i class="fa fa-user mx-2"
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="banner_taital_main">
                                        <h1 class="banner_taital">LAYANAN SEWA ALAT BERAT</h1>
                                        <p class="banner_text">Yetera adalah aplikasi terpercaya untuk menyewa alat
                                            berat dengan mudah dan nyaman. </p>
                                        <div class="btn_main">
                                            <div class="started_text active"><a href="#">Kontak Kami</a></div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <p class="services_text_1">
                        Berikut adalah beberapa layanan yang kami tawarkan di aplikasi Yetera.
                    </p>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-6">
                        <div class="box_main active">
                            <div class="service_img"><img src="{{ asset('landing/images/icon-1.png') }}"></div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="box_main">
                            <div class="service_img"><img src="{{ asset('landing/images/icon-2.png') }}"></div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="box_main">
                            <div class="service_img"><img src="{{ asset('landing/images/icon-3.png') }}"></div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="box_main">
                            <div class="service_img"><img src="{{ asset('landing/images/icon-4.png') }}"></div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="container_main">
                                                <img src="{{ asset('landing/images/img-1.png') }}" alt=""
                                                    class="image">
                                                <div class="overlay">
                                                    <div class="text">
                                            ...
                                            <div class="project_main">
                                                ...
                                                <p class="dummy_text">alteration in some form, by injected humour, or
                                        ...
                                        <div class="col-md-4">
                                            <div class="container_main">
                                                <img src="{{ asset('landing/images/img-2.png') }}" alt=""
                                                    class="image">
                                                <div class="overlay">
                                                    <div class="text">
                                                        <h4 class="some_text"><i class="fa fa-link"
                                        ...
                                        <div class="col-md-4">
                                            <div class="container_main">
                                                <img src="{{ asset('landing/images/img-3.png') }}" alt=""
                                                    class="image">
                                                <div class="overlay">
                                                    <div class="text">
                                                        <h4 class="some_text"><i class="fa fa-link"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="testimonial_section_2">
                                    ...
                                    <p class="textimonial_text">Lorem ipsum dolor sit amet, consectetur adipiscing
